...
public final class ItineraryPdfExporter {
    ...
    private static String slotLabel(Context context,String slot){int res=MealSlotMapper.labelRes(slot);return res==0?slot:context.getString(res);}
